...
class DataProcessor:
    ...
    def load_data(self, usecols):
        try:
            ...
            logger.info("Data Loaded successfully for data processinh") 
    ...
    def scale_ratings(self):
        try: 
            ...
            logger.info("Scaling donefor Processing")
        except Exception as e:
    ...
    def save_artifacts(self):
        try:
            ...
            logger.info("All training, testing data as well as rating_df is saved.....")
    ...
    def process_anime_data(self):
        try:
            ...
            logger.info("DF and Synopsis_df saved succesfully")
